    ...
    <div class="modal fade modal_update" id="modal-lg" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="updateModal" action="{{ route('organization.categories.chucdanh.chinhsua') }}">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="identity"
                                        aria-describedby="emailHelp" placeholder="Mã chức danh" name="identity">
                                </div>
